...
<body>
    ...
    <!-- Video -->
    <video id="big-video-vid_html5_api" class="vjs-tech" preload="auto" data-setup="{}" autoplay="" webkit-playsinline="" poster="null" src="video/1" style="position: fixed; /*width: 1203.55555555556px;*/height:1000px" muted loop></video>

    <!-- <video id="big-video-vid_html5_api" class="vjs-tech" preload="auto" data-setup="{}" autoplay="" webkit-playsinline="" poster="null" src="video/1" style="position: fixed; /*width: 1203.55555555556px;*/width: 100%;height:100vh" muted loop></video> -->
